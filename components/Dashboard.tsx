...
const DARK_COLORS = ['#3b82f6', '#334155', '#991b1b']; // Blue, Lighter Slate (visible on dark bg), Red
                    ...
                    <div className="w-full h-48 relative">
                        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                            <div className="text-center">
                                <span className="text-3xl font-bold text-slate-700 dark:text-slate-200">{stats.completionRate}%</span>
